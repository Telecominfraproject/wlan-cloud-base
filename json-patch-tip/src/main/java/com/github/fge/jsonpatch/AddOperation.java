...
public final class AddOperation extends PathValueOperation
{
    ...
    private JsonNode apply(final JsonNode node, boolean ignoreInvalidPaths) throws JsonPatchException
    {
        if (path.isEmpty())
            return value;
   ...
   @Override
   public JsonNode applyWhileIgnoringInvalidPaths(JsonNode node) throws JsonPatchException 
   { 
