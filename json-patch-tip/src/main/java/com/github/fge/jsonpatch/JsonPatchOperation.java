    ...
    implements JsonSerializable
{
    ...
    /**
     * Apply this operation to a JSON value while ignoring any
     ...
     * @throws JsonPatchException operation failed to apply to this value
     */
    public abstract JsonNode applyWhileIgnoringInvalidPaths(final JsonNode node) throws JsonPatchException;
