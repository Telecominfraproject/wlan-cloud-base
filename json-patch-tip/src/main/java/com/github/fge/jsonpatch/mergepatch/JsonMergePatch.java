    ...
    implements JsonSerializable
{
    ...
    /**
     * Apply the patch to a given JSON value and ignore an invalid paths.
     * 
     * This is to help patching source objects that changes slighly (ie: had a member deleted).
     * 
     * This is to align our current way of patching to our current use of Jackson for 
     * serializing our objects. Whenever we obsolete a parameter and deserialize the object, we 
     * simply ignore the arguments that have been removed.
     * 
     * @param input the value to patch
     * @return the patched value
     * @throws JsonPatchException never thrown; only for consistency with
     ...
     * @throws NullPointerException value is null
     */
    public abstract JsonNode applyWhileIgnoreInvalidPaths(final JsonNode input)
        throws JsonPatchException;
