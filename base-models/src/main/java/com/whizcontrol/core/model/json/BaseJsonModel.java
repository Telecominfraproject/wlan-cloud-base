...
import com.whizcontrol.server.exceptions.SerializationException;

/**
 * All sub-classes are registered automatically with the static
 * {@link ObjectMapper} as long as it's in "com.whizcontrol" package. The
...
public abstract class BaseJsonModel implements Cloneable, Serializable {
    ...
    public static void registerAllSubtypes(ObjectMapper objectMapper){
        ...
        //scan urls that contain 'com.whizcontrol', use the default scanners
        Reflections reflections = new Reflections("com.whizcontrol");
